...
class verdemo extends Component {
    constructor(props) {
        super(props);
        this.state = {
            fullName: '',
                                                ...
                                                <form className="login-form" onSubmit={this.handleSubmit}>
                                                    ...
                                                    <div className="col-lg-12 mt-4">
                                                        ...
                                                        >
                                                            ...
                                                            <option value="Optimizacion del Producto">Optimizacion del Producto</option>
...
export default connect(mapStatetoProps, mapDispatchtoProps)(verdemo);
